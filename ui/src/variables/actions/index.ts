...
import {getValues} from 'src/variables/utils/graph'
...
// Utils
import {getValueSelections} from 'src/variables/selectors'
...
export const refreshVariableValues = (
  ...
  try {
    ...
    const values = await getValues(orgID, variables, selections)
